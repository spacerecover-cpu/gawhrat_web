...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-30 flex size-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-lift transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:scale-105 active:scale-95"
    >
